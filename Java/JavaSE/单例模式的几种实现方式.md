...
![img](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/2018032712264841)

单例模式的懒汉式体现了缓存的思想，延时加载就是一开始不要加载资源或者数据，一直 等，等到马上就要使用这个资源的或者数据了，躲不过去了才去加载。

懒汉式是定性的时间换空间，不加同步的懒汉式是线程不安全的，如下示例：

![img](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/20180327123758498)
...
![img](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/20200102125816762.png)
