...
　　　　　　　　　　　![ThreadLocal可能引起的内存泄露.jpg-127.3kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/kenengyinqide%20neicunxielou.jpg)
...
　　　　　　　　　　　![Jconsole死锁.png-26.7kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/sesuo.png)

------

(2). Jstack：JDK自带的命令行工具，主要用于线程Dump分析。

　　　　　　　　　　　![这里写图片描述](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/demo3.jpg)

------

(3). VisualVM：JDK自带的图形化界面工具，主要用于对 Java 应用程序做性能分析和调优。

　　　　　　　　　　　![VisualVM死锁.jpg-240.8kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/VMsesuo.jpg)
...
- 阻塞队列：BlockingQueue
  ...
  　　　　　　　　　　　![线程池的处理流程.jpg-25.3kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/xianchengchidesisuoguocheng.jpg)
...
　　　　　　　　　　　![FutureAPI.png-9.4kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/FutureAPI.png)
...
　　　　　　　　　　　![AQS.png-26.4kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/AQS.png)
...
- await/signal/signalAll：将线程分为消费者线程和生产者线程两组：在队列为空时，通知生产者线程生产；在队列满时，通知消费者线程消费。
  ...
  　　　　　　　　　　　![Condition.png-66.2kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/Condition.png)
...
　　　　　　　　　　　![同步容器.png-145.7kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/tongburongqi.png)
...
- get操作是弱一致的：get操作只能保证一定能看到已完成的put操作；
  ...
  　　　　　　　　　　　![ConcurrentHashMap的弱一致性.png-136.8kB](https://cdn.jsdelivr.net/gh/2234416233/myImage/img/ConcurrentHashMapdeweiyiruoxing.png)
