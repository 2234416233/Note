...
int countPrimes(int n) {
    ...
    int count = 0;
    for (int i = 2; i < n; i++)
        if (isPrim[i]) count++;![1571900871-ced4943e8e64be0](C:\Users\fang\Downloads\1571900871-ced4943e8e64be0.gif)

    return count;
}
```

![](https://gcore.jsdelivr.net/gh/2234416233/myImage/img/1571900871-ced4943e8e64be0.gif)
